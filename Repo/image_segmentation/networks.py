...
class BaseNet(nn.Module):
    def __init__(self, n_in_channels: int = 1, n_hidden_layers: int = 3, n_kernels: int = 12, kernel_size: int = 5):
        ...
        self.preoutput_layer = torch.nn.Conv2d(in_channels=n_in_channels, out_channels=2,
